<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <a class="brand" href="#">SAAS app <small>admin v1.0</small></a>
          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
						...
						array(
							'label'=>'Admin <span class="caret"></span>', 
							'url'=>'#','itemOptions'=>array(
								'class'=>'dropdown','tabindex'=>"-1"),
								'linkOptions'=>array(
									'class'=>'dropdown-toggle','data-toggle'=>"dropdown"
								), 
								'items'=>array(
									array('label'=>'Users', 'url'=>array('/user/profileField/admin')),
									array('label'=>'Permissions', 'url'=>array('/rights/authItem/roles')),
									array('label'=>'Plans', 'url'=>array('/plans/admin')),
									array('label'=>'Configuration', 'url'=>array('/configs/admin')),
								)
						),
						
                        array(
							'label'=>'Theme Pages <span class="caret"></span>', 
							'url'=>'#','itemOptions'=>array(
								'class'=>'dropdown','tabindex'=>"-1"),
								'linkOptions'=>array(
									'class'=>'dropdown-toggle','data-toggle'=>"dropdown"
